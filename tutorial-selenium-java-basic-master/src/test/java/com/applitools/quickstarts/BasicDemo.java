...
//		}
		...
		eyes.setApiKey("LIVOyMqhZ0GMWKaGUp3pfw8j4OjN110j0Eagry3iSeEMg110");

		// set batch name
		eyes.setBatch(batch);

		// Use Firefox browser
		System.setProperty("webdriver.gecko.driver", "C:\\sudhish\\Wipro\\geckodriver-v0.26.0-win64\\geckodriver.exe");
